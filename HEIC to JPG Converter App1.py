...
# label2 = py.Text("Choose Destination Folder")
# input_box2 = py.InputText()
# choose_button2 = py.FolderBrowse("Choose", key='dest')
convert_button = py.Button("Convert")
output_label = py.Text(key="output")



window = py.Window("HEIC Converter", layout=[[label, input_box, choose_button], [convert_button, output_label]])
...
while True:
    ...
    window["output"].update(value="Convertion Completed!")
